...
export const PumpSafetyModal: React.FC<PumpSafetyModalProps> = ({
  ...
  return (
    <div id="pump-safety-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
      <div 
        id="pump-safety-modal-content" 
        className="bg-slate-900 rounded-3xl max-w-lg w-full border border-slate-800 shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden animate-in zoom-in-95 duration-200 relative"
      >
        {/* Modal Header */}
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-4 flex items-center justify-between text-xs">
            <div>
              ...
              <span className="text-lg font-mono font-bold text-slate-100 mt-0.5 block">
            ...
            <div className="text-right">
              ...
              <span className="text-lg font-mono font-bold text-amber-400 mt-0.5 block">{config.pumpOffPercent}%</span>
            </div>
          </div>
        ...
        <div className="p-4 bg-slate-950/80 border-t border-slate-800 flex items-center justify-end gap-3">
          ...
          <button
            ...
            className={`px-5 py-2.5 text-xs font-bold uppercase tracking-tight rounded-xl transition-all flex items-center gap-2 cursor-pointer ${
              isTurningOn
                ? safetyChecked 
