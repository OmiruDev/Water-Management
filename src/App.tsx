...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 flex flex-col antialiased selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <header className="bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-2xl bg-blue-600/20 border border-blue-500/50 text-blue-400 flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.3)]">
              <Waves className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2.5">
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
                  H2O SENSE PRO
                </h1>
                <span className="text-[10px] bg-blue-500/10 text-blue-400 font-mono font-bold px-2 py-0.5 rounded-full border border-blue-500/30 uppercase tracking-widest">
                  ESP32 • Gemini AI
                </span>
              </div>
              <p className="text-[11px] text-slate-400 tracking-widest uppercase font-medium">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-blue-600/20 border border-blue-500/50 hover:bg-blue-600/30 px-3.5 sm:px-5 py-2 rounded-lg flex items-center justify-center cursor-pointer transition-all shadow-[0_0_15px_rgba(59,130,246,0.15)] group"
            >
              <span className="text-xs font-bold text-blue-400 uppercase tracking-tight group-hover:text-blue-300">
                Pump Control
              </span>
            </button>
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg border border-slate-800 bg-slate-900/80 hover:bg-slate-800/80 text-xs font-semibold text-slate-300 hover:text-white transition-all flex items-center gap-1.5"
            >
            ...
            {simulatedLeakLph > 0 && (
              <div className="flex items-center gap-1.5 bg-red-500/10 text-red-400 border border-red-500/30 px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-tight animate-pulse">
                <Droplet className="w-3.5 h-3.5" />
                <span>Leak: {simulatedLeakLph} L/h</span>
              </div>
            )}
            ...
            <button
              ...
              className="relative p-2.5 rounded-lg bg-slate-900/80 border border-slate-800 text-slate-300 hover:text-white hover:border-slate-700 transition-colors"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-2 overflow-x-auto py-2.5 text-xs font-semibold border-t border-slate-800/80">
          {[
            ...
            return (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg whitespace-nowrap transition-all flex items-center gap-2 ${
                  isActive
      ...
      {/* Immersive UI Footer */}
      <footer className="border-t border-slate-800/80 bg-[#020617] py-4 mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6 text-slate-400">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Signal RSSI</span>
              <span className="text-xs font-mono text-emerald-400">{telemetry.rssi} dBm</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Node ID</span>
              <span className="text-xs font-mono text-slate-300">{config.deviceId}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-red-500/10 text-red-400 px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border border-red-500/20">
              System Armed
            </div>
          </div>
        </div>
